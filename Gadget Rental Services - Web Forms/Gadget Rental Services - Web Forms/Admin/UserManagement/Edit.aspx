<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="Gadget_Rental_Services___Web_Forms.Admin.UserManagement.Edit" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">            
            <div class="col-md-offset-2 col-md-10">
                <asp:CheckBox runat="server" ID="chkResetPassword" OnCheckedChanged="chkResetPassword_CheckedChanged" AutoPostBack="true" />
                <asp:Label runat="server" ID="lblResetPassword" AssociatedControlID="chkResetPassword">Change User Password?</asp:Label>
            </div>
        </div> 
        ...
        <div class="form-group">
            <asp:Label runat="server" ID ="lblConfirmPasword" AssociatedControlID="txtConfirmPassword" CssClass="col-md-2 control-label">Confirm password</asp:Label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" ID="btnSubmit" Text="Update User" OnClick="btnSubmit_Click" CssClass="btn btn-default" />
            </div>
        </div>
